...
```{r ans11}
transcriptData[transcriptData$學號=="92a7G9fee",]->subsample
```
...
設計一個學分數計算函數稱之為totalCredits，當我們給它學號字串，它便會回傳給我們「學號」、「總修習學分數」、「總實得學分數」三項值。以上題為例,`totalCredits("92a7G9fee")`會回傳上題答案值。
